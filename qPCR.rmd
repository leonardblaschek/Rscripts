...
write_tsv(plate, "/home/leonard/Documents/Uni/PhD/qPCR/2020-10-26_plate.tsv")

results <- read_tsv("/home/leonard/Documents/Uni/PhD/qPCR/2020-10-26_cp.tsv",
  skip = 1
) %>%
  left_join(plate) %>%
  drop_na(sample)
...
write_tsv(plate, "/home/leonard/Documents/Uni/PhD/qPCR/2020-10-27_plate.tsv")

results <- read_tsv("/home/leonard/Documents/Uni/PhD/qPCR/2020-10-27_cp.tsv",
  skip = 1
) %>%
  left_join(plate)
...
write_tsv(plate, "/home/leonard/Documents/Uni/PhD/qPCR/2020-10-28_plate.tsv")

results <- read_tsv("/home/leonard/Documents/Uni/PhD/qPCR/2020-10-28_cp.tsv",
  skip = 1
) %>%
  left_join(plate)
...
write_tsv(plate, "/home/leonard/Documents/Uni/PhD/qPCR/2020-10-31_plate.tsv")

results <- read_tsv("/home/leonard/Documents/Uni/PhD/qPCR/2020-10-31_cp.tsv",
  skip = 1
) %>%
  left_join(plate)
...
write_tsv(plate, "/home/leonard/Documents/Uni/PhD/qPCR/2020-11-02_plate.tsv")

results <- read_tsv("/home/leonard/Documents/Uni/PhD/qPCR/2020-11-02_cp.tsv",
  skip = 1
) %>%
  left_join(plate)
...
result_files <-
  list.files(
    path = "/home/leonard/Documents/Uni/PhD/qPCR/",
    pattern = "cp.tsv",
    recursive = FALSE,
    full.names = TRUE
  )
