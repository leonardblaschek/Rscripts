...
stat_tab <- heights %>% 
  ...
  anova_tab <- stat_tab$anova %>% 
    distinct()
  write_csv(anova_tab, paste0(stat_path, "S09H_anova.csv"))

  tukey_tab <- stat_tab$tukey %>%
    distinct()
  write_csv(tukey_tab, paste0(stat_path, "S09H_tukey.csv"))
...
pdf("transpiration_supplement.pdf", width = twocol * 1.05, height = onecol * 0.8)
