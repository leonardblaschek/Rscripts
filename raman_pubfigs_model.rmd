...
auc_boxes <- ggplot(data = rmn_data_all_auc, aes(x = cell.type, y = auc / 1000)) +
  ...
  scale_fill_viridis_d() +
  theme_leo() +
  labs(y = expression(paste("AUC per 490 µm"^2, " [AU]"))) +
...
plot_grid(spectra("Interfascicular fibre"),
  auc_boxes("IF"),
  spectra("Vascular bundle"),
  auc_boxes("VB"),
...
ggplot(rmn_auc_contrib, aes(x = band, y = proportion)) +
  ...
  scale_fill_viridis_d() +
  scale_x_discrete(labels = c("1099", "1334", "1603", "381")) +
...
pdf("Raman_figureS3.pdf", width = onecol, height = onecol)
ggplot(rmn_auc, aes(
  x = AUC,
  ...
  labs(y = expression(paste("Added peak intensities at 1603, 1334, 1099 and 381 cm"^-1)),
       x = "Total AUC") +
  geom_text(
    x = 750000,
    y = 45000,
