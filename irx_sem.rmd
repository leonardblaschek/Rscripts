...
ggplot(data = filter(x, cell.type == y)) +
  ...
  annotate("text", label = y, y = max(x$intensity.mean[x$cell.type == y]), x = 2000)
}

plot_correlations(irx_raman_corr, "PX", "PiYG")
plot_correlations(irx_raman_corr, "PMX", "PuOr")
plot_correlations(irx_raman_corr, "SMX", "RdBu")
```
