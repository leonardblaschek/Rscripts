...
qPCR_profiles <- ggplot(
  ...
  scale_y_continuous(labels = clean_zero) +
  labs(x = "Days past induction",
       y = "Relative expression [RT-qPCR &#8710;Ct]") +
  theme_leo() +
  theme(
    strip.placement = "outside",
...
full_mutant_plot + 
  ...
  plot_annotation(
    tag_levels = list(c("A", "B", "C", "D", "E", "F", "G", "L", "M"))
  ) &
  theme(plot.tag = element_text(size = 10, face = "bold", family = "Helvetica"))
dev.off()
```
...
ref_labels <- tribble(
  ...
  "cad4x5", "IF", "<sup>G<sub>CHO&thinsp;</sub></sup>&frasl;<sub>G<sub>CHOH</sub></sub>", "<i>cad4;5</i> IF (overaccumulates G<sub>CHO</sub>)"
)
...
ref_labels <- tribble(
  ...
  # "cad4x5", "IF", "G<sub>CHOH</sub>", "<i>cad4;5</i> IF (depleted of G<sub>CHOH</sub>)",
  "cad4x5", "IF", "G<sub>CHO</sub>", "<i>cad4;5</i> IF (overaccumulates G<sub>CHO</sub>)"
)
