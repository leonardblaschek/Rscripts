...
pdf("lac_collapse.pdf", width = onecol, height = onecol * 0.25)
collapse_plot
dev.off()
...
letters <- letter_groups(swelling_data,
                         thickness,
                         state,
                         "tukey",
                         genotype,
...
ggplot(swelling_data,
  ...
  facet_grid(cell_type ~ genotype, scales = "free_y")
```
