...
ref_labels <- tribble(
  ...
  "cad4x5", "IF", "<sup>**G**<sub>CHO&thinsp;</sub></sup>&frasl;<sub>**G**<sub>CHOH</sub></sub>", "<i>cad4</i>x<i>5</i> IF (overaccumulates <b>G</b><sub>CHO</sub>)"
)
...
ref_labels <- tribble(
  ...
  "cad4x5", "IF", "<b>G</b><sub>CHOH</sub>", "<i>cad4</i>x<i>5</i> IF (depleted of <b>G</b><sub>CHOH</sub>)",
  "cad4x5", "IF", "<b>G</b><sub>CHO</sub>", "<i>cad4</i>x<i>5</i> IF (overaccumulates <b>G</b><sub>CHOH</sub>)"
)
