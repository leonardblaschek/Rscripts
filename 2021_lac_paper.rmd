...
ref_labels <- tribble(
  ...
  "fah1", "MX", "<sup>**S**</sup>&frasl;<sub>**G**</sub>", "<i>fah1</i> MX (traces of <b>S</b>)",
...
ref_labels <- tribble(
  ~genotype, ~cell_type, ~variable, ~label,
  "fah1", "MX", "<b>S</b>", "<i>fah1</i> MX (traces of <b>S</b>)",
  "fah1", "MX", "<b>G</b>", "<i>fah1</i> MX (overaccumulates <b>G</b>)",
  # "cad4x5", "IF", "<b>G</b><sub>CHOH</sub>", "<i>cad4;5</i> IF (depleted of <b>G</b><sub>CHOH</sub>)",
  "cad4x5", "IF", "<b>G</b><sub>CHO</sub>", "<i>cad4;5</i> IF (overaccumulates <b>G</b><sub>CHO</sub>)"
)
...
rmn_maule_plot <- ggplot(rmn_maule,
  ...
  labs(y = "Mäule hue",
       x = "Log<sub><i>e</i></sub> Raman <sup><b>S</b></sup>/<sub><b>G</b></sub>") +
  theme_leo() +
...
pdf("expression_bars.pdf", height = onecol, width = onecol)
ex_bar
dev.off()
```
