...
collapse_data_full <- collapse_data
collapse_data <- collapse_data %>% filter(cell_type != "SX")
```

#### Calculate perimeters

```{r}
perimeters <- collapse_data_full %>%
...
pdf("lac_collapse_full.pdf", width = onecol, height = onecol * 0.8)
collapse_plot
dev.off()
```
