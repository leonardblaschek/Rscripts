...
#durocher SEM
durocher <- read.csv("file:///home/leonard/Dropbox/2019 Stockholm Course/9_Mixed_Models/durocher.csv")
head(durocher, n = 1)
...
sem.data <- read.csv("file:///home/leonard/Dropbox/SEM_data.csv") %>%
  select(-replicate, -X, -X1599...cm....1.1119..cm....1) %>%
...
chart.Correlation(select(ungroup(sem.data), -genotype, -cell.type), histogram=TRUE, pch=21)
```
