...
All in all, at this point, I don't see much else to do except including figure S2 as I've sent it to you earlier:
...
# Add activty of autoclaved sections
...
I only have DAF/PYGL data for WT and Q; for DAB the only autoclaved data I have is – unfortunately – from a single WT section.
...
- Change the letter of the statistical test in Fig S5 panel B for MX --- **done**
