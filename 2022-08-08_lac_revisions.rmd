...
As discussed, this is the proposed new figure S1, including timelines of TE differentiation and gene expression determined by microarray and RT-qPCR analysis, and culture lignin analysis by pyrolysis.

```{r, echo=FALSE, fig.align='center'}
knitr::include_graphics("Blaschek2022_figureS1.pdf")
```
