...
### Check correlations between yearly temperatures and humidity

```{r}

pdf("c4h_envir_correlations.pdf", width = 10, height = 10)
chart.Correlation(envir[,-c(1,12, 13)])
dev.off()
...
write_csv(c4h_coefficients, "model_coefficients.csv")
...
write_csv(c4h_models, "model_statistics.csv")
