...
pdf("lig_violin.pdf", width = twocol, height = twocol)
lig_violin
dev.off()
```
...
pca <- ggplot(gg_pca, aes(x = PC1, y = PC2, fill = genotype)) +
  ...
  geom_text(data = filter(gg_pca, cell == 5 & replicate == 4), aes(label = genotype)) +
