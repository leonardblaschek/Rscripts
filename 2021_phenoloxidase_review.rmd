...
model_data <- his_depth %>% 
  ...
  pivot_longer(c(HIS_451, HIS_519, Vol_sa, mouth_area_sa), 
...
clust <- reorder(
  ...
  -clust_data$HIS_451, agglo.FUN = "mean")
...
violins <- ggplot(model_data,
  ...
  geom_text(data = ref_data %>% filter(parameter == "HIS_451"),
            ...
            family = "Helvetica",
            size = ggtext_size) +
  geom_text(data = tibble(parameter = c("Vol_sa", "Vol_sa")),
            x = 24,
            y = c(70, 400),
            ...
            family = "Helvetica",
            size = ggtext_size) +
  geom_segment(data = tibble(parameter = c("Vol_sa", "Vol_sa")),
             aes(xend = 24,
                 yend = c(170, 380),
                 x = 24,
                 y = 240),
  ...
  theme(legend.position = c(0.83, 1.025),
        ...
        strip.text = ggtext::element_markdown(hjust = 0.5, face = "plain", 
